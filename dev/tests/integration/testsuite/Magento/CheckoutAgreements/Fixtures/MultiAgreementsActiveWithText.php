...
class MultiAgreementsActiveWithText implements \Magento\TestFramework\Fixture\FixtureInterface
{
    ...
    {
        $this->getData()->setFirstAgreement($this->createAgreement('First Checkout Agreement (active)'));
        $this->getData()->setSecondAgreement($this->createAgreement('Second Checkout Agreement (active)'));
    }
